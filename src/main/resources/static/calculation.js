...
//
                ...
                html += '<button type="button" class="btn btn-danger col-1" ><div class="text-wrap">Remove</div></button>';
                html += '<button type="button" class="btn btn-warning col-1"><div class="text-wrap">Change</div><</button>';
                html += '</div>'
                html += '</div>'
            }
